...
import org.icreated.wstore.endpoints.PrivateEndpoint;
...
public class WStoreApplication extends ResourceConfig {
    ...
    public WStoreApplication() {
    	...
    	register(RolesAllowedDynamicFeature.class);	//aslinya diremark
...
//   	    register(new LoggingFilter());				//aslinya diremark
    	
//		register(GZipEncoder.class);				//aslinya diremark
    	...
    	//add by natha: 05-april-2021
        register(PrivateEndpoint.class);
    }
