...
public class JwtAuthenticationFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        if(!method.isAnnotationPresent(PermitAll.class) &&
        	(clazz.isAnnotationPresent(RolesAllowed.class) || method.isAnnotationPresent(RolesAllowed.class))) {
        	
        	/* bukak */
        	RolesAllowed rolesAnnotation;
        	if (clazz.isAnnotationPresent(RolesAllowed.class)) {
        		rolesAnnotation = clazz.getAnnotation(RolesAllowed.class);
        	} else {
            ...
            requestContext.setSecurityContext(new CustomSecurityContext(sessionUser, requestContext.getSecurityContext().isSecure()));
        }
